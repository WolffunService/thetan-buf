...
type ThetanRivalServiceClient interface {
	// Profile
	GetUserProfile(context.Context, *connect_go.Request[gen.UserProfileRequest]) (*connect_go.Response[gen.UserProfileResponse], error)
	// Minions
	GetUserMinions(context.Context, *connect_go.Request[gen.UserMinionsRequest]) (*connect_go.Response[gen.UserMinionsResponse], error)
	GetUserSelectedMinion(context.Context, *connect_go.Request[gen.UserSelectedMinionRequest]) (*connect_go.Response[gen.UserSelectedMinionResponse], error)
	GetMinion(context.Context, *connect_go.Request[gen.MinionRequest]) (*connect_go.Response[gen.MinionResponse], error)
	CreateMinion(context.Context, *connect_go.Request[gen.CreateMinionRequest]) (*connect_go.Response[gen.CreateMinionResponse], error)
	// Friends
	GetListFriends(context.Context, *connect_go.Request[gen.GetUserFriendRequest]) (*connect_go.Response[gen.GetUserFriendResponse], error)
	GetMatchInfoOnboarding(context.Context, *connect_go.Request[gen.GetMatchInfoRequest]) (*connect_go.Response[gen.GetMatchInfoResponse], error)
	// Lobby
	GetLatestLobbyActivityInfo(context.Context, *connect_go.Request[gen.GetActivityRequest]) (*connect_go.Response[gen.GetActivityResponse], error)
}
...
func NewThetanRivalServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) ThetanRivalServiceClient {
	...
	return &thetanRivalServiceClient{
		getUserProfile: connect_go.NewClient[gen.UserProfileRequest, gen.UserProfileResponse](
			httpClient,
			baseURL+ThetanRivalServiceGetUserProfileProcedure,
			opts...,
		),
		getUserMinions: connect_go.NewClient[gen.UserMinionsRequest, gen.UserMinionsResponse](
			httpClient,
			baseURL+ThetanRivalServiceGetUserMinionsProcedure,
			opts...,
		),
		getUserSelectedMinion: connect_go.NewClient[gen.UserSelectedMinionRequest, gen.UserSelectedMinionResponse](
			httpClient,
			baseURL+ThetanRivalServiceGetUserSelectedMinionProcedure,
			opts...,
		),
		getMinion: connect_go.NewClient[gen.MinionRequest, gen.MinionResponse](
			httpClient,
			baseURL+ThetanRivalServiceGetMinionProcedure,
			opts...,
		),
		createMinion: connect_go.NewClient[gen.CreateMinionRequest, gen.CreateMinionResponse](
			httpClient,
			baseURL+ThetanRivalServiceCreateMinionProcedure,
			opts...,
		),
		getListFriends: connect_go.NewClient[gen.GetUserFriendRequest, gen.GetUserFriendResponse](
			httpClient,
			baseURL+ThetanRivalServiceGetListFriendsProcedure,
			opts...,
		),
		getMatchInfoOnboarding: connect_go.NewClient[gen.GetMatchInfoRequest, gen.GetMatchInfoResponse](
			httpClient,
			baseURL+ThetanRivalServiceGetMatchInfoOnboardingProcedure,
			opts...,
		),
		getLatestLobbyActivityInfo: connect_go.NewClient[gen.GetActivityRequest, gen.GetActivityResponse](
			httpClient,
...
type thetanRivalServiceClient struct {
	getUserProfile             *connect_go.Client[gen.UserProfileRequest, gen.UserProfileResponse]
	getUserMinions             *connect_go.Client[gen.UserMinionsRequest, gen.UserMinionsResponse]
	getUserSelectedMinion      *connect_go.Client[gen.UserSelectedMinionRequest, gen.UserSelectedMinionResponse]
	getMinion                  *connect_go.Client[gen.MinionRequest, gen.MinionResponse]
	createMinion               *connect_go.Client[gen.CreateMinionRequest, gen.CreateMinionResponse]
	getListFriends             *connect_go.Client[gen.GetUserFriendRequest, gen.GetUserFriendResponse]
	getMatchInfoOnboarding     *connect_go.Client[gen.GetMatchInfoRequest, gen.GetMatchInfoResponse]
	getLatestLobbyActivityInfo *connect_go.Client[gen.GetActivityRequest, gen.GetActivityResponse]
}

// GetUserProfile calls services.ThetanRivalService.GetUserProfile.
func (c *thetanRivalServiceClient) GetUserProfile(ctx context.Context, req *connect_go.Request[gen.UserProfileRequest]) (*connect_go.Response[gen.UserProfileResponse], error) {
	return c.getUserProfile.CallUnary(ctx, req)
}

// GetUserMinions calls services.ThetanRivalService.GetUserMinions.
func (c *thetanRivalServiceClient) GetUserMinions(ctx context.Context, req *connect_go.Request[gen.UserMinionsRequest]) (*connect_go.Response[gen.UserMinionsResponse], error) {
	return c.getUserMinions.CallUnary(ctx, req)
}

// GetUserSelectedMinion calls services.ThetanRivalService.GetUserSelectedMinion.
func (c *thetanRivalServiceClient) GetUserSelectedMinion(ctx context.Context, req *connect_go.Request[gen.UserSelectedMinionRequest]) (*connect_go.Response[gen.UserSelectedMinionResponse], error) {
	return c.getUserSelectedMinion.CallUnary(ctx, req)
}

// GetMinion calls services.ThetanRivalService.GetMinion.
func (c *thetanRivalServiceClient) GetMinion(ctx context.Context, req *connect_go.Request[gen.MinionRequest]) (*connect_go.Response[gen.MinionResponse], error) {
	return c.getMinion.CallUnary(ctx, req)
}

// CreateMinion calls services.ThetanRivalService.CreateMinion.
func (c *thetanRivalServiceClient) CreateMinion(ctx context.Context, req *connect_go.Request[gen.CreateMinionRequest]) (*connect_go.Response[gen.CreateMinionResponse], error) {
	return c.createMinion.CallUnary(ctx, req)
}

// GetListFriends calls services.ThetanRivalService.GetListFriends.
func (c *thetanRivalServiceClient) GetListFriends(ctx context.Context, req *connect_go.Request[gen.GetUserFriendRequest]) (*connect_go.Response[gen.GetUserFriendResponse], error) {
	return c.getListFriends.CallUnary(ctx, req)
}

// GetMatchInfoOnboarding calls services.ThetanRivalService.GetMatchInfoOnboarding.
func (c *thetanRivalServiceClient) GetMatchInfoOnboarding(ctx context.Context, req *connect_go.Request[gen.GetMatchInfoRequest]) (*connect_go.Response[gen.GetMatchInfoResponse], error) {
...
func (c *thetanRivalServiceClient) GetLatestLobbyActivityInfo(ctx context.Context, req *connect_go.Request[gen.GetActivityRequest]) (*connect_go.Response[gen.GetActivityResponse], error) {
...
func (UnimplementedThetanRivalServiceHandler) GetUserProfile(context.Context, *connect_go.Request[gen.UserProfileRequest]) (*connect_go.Response[gen.UserProfileResponse], error) {
...
func (UnimplementedThetanRivalServiceHandler) GetUserMinions(context.Context, *connect_go.Request[gen.UserMinionsRequest]) (*connect_go.Response[gen.UserMinionsResponse], error) {
...
func (UnimplementedThetanRivalServiceHandler) GetUserSelectedMinion(context.Context, *connect_go.Request[gen.UserSelectedMinionRequest]) (*connect_go.Response[gen.UserSelectedMinionResponse], error) {
...
func (UnimplementedThetanRivalServiceHandler) GetMinion(context.Context, *connect_go.Request[gen.MinionRequest]) (*connect_go.Response[gen.MinionResponse], error) {
...
func (UnimplementedThetanRivalServiceHandler) CreateMinion(context.Context, *connect_go.Request[gen.CreateMinionRequest]) (*connect_go.Response[gen.CreateMinionResponse], error) {
...
func (UnimplementedThetanRivalServiceHandler) GetListFriends(context.Context, *connect_go.Request[gen.GetUserFriendRequest]) (*connect_go.Response[gen.GetUserFriendResponse], error) {
...
func (UnimplementedThetanRivalServiceHandler) GetMatchInfoOnboarding(context.Context, *connect_go.Request[gen.GetMatchInfoRequest]) (*connect_go.Response[gen.GetMatchInfoResponse], error) {
...
func (UnimplementedThetanRivalServiceHandler) GetLatestLobbyActivityInfo(context.Context, *connect_go.Request[gen.GetActivityRequest]) (*connect_go.Response[gen.GetActivityResponse], error) {
