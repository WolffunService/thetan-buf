...
type GetLobbyBotsRequest struct {
...
func (x *GetLobbyBotsRequest) Reset() {
	*x = GetLobbyBotsRequest{}
...
func (x *GetLobbyBotsRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLobbyBotsRequest) ProtoMessage() {}

func (x *GetLobbyBotsRequest) ProtoReflect() protoreflect.Message {
	mi := &file_thetan_bot_v1_bot_rivals_proto_msgTypes[0]
...
// Deprecated: Use GetLobbyBotsRequest.ProtoReflect.Descriptor instead.
func (*GetLobbyBotsRequest) Descriptor() ([]byte, []int) {
	return file_thetan_bot_v1_bot_rivals_proto_rawDescGZIP(), []int{0}
}

func (x *GetLobbyBotsRequest) GetTownID() string {
	if x != nil {
		return x.TownID
	}
	return ""
...
type GetLobbyBotsResponse struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *GetLobbyBotsResponse) Reset() {
	*x = GetLobbyBotsResponse{}
	if protoimpl.UnsafeEnabled {
...
func (x *GetLobbyBotsResponse) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*GetLobbyBotsResponse) ProtoMessage() {}

func (x *GetLobbyBotsResponse) ProtoReflect() protoreflect.Message {
	mi := &file_thetan_bot_v1_bot_rivals_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use GetLobbyBotsResponse.ProtoReflect.Descriptor instead.
func (*GetLobbyBotsResponse) Descriptor() ([]byte, []int) {
	return file_thetan_bot_v1_bot_rivals_proto_rawDescGZIP(), []int{1}
}

func (x *GetLobbyBotsResponse) GetBots() []*BotInfo {
	if x != nil {
		return x.Bots
	}
	return nil
...
var file_thetan_bot_v1_bot_rivals_proto_rawDesc = []byte{
	...
	0x76, 0x31, 0x22, 0x2d, 0x0a, 0x13, 0x47, 0x65, 0x74, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x42, 0x6f,
	...
	0x44, 0x22, 0x45, 0x0a, 0x14, 0x47, 0x65, 0x74, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x42, 0x6f, 0x74,
	...
	0x70, 0x69, 0x72, 0x65, 0x73, 0x41, 0x74, 0x32, 0x73, 0x0a, 0x10, 0x42, 0x6f, 0x74, 0x52, 0x69,
	0x76, 0x61, 0x6c, 0x73, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x12, 0x5f, 0x0a, 0x0c, 0x47,
	0x65, 0x74, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x42, 0x6f, 0x74, 0x73, 0x12, 0x25, 0x2e, 0x74, 0x68,
	0x65, 0x74, 0x61, 0x6e, 0x2e, 0x72, 0x69, 0x76, 0x61, 0x6c, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x47,
	0x65, 0x74, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x42, 0x6f, 0x74, 0x73, 0x52, 0x65, 0x71, 0x75, 0x65,
	0x73, 0x74, 0x1a, 0x26, 0x2e, 0x74, 0x68, 0x65, 0x74, 0x61, 0x6e, 0x2e, 0x72, 0x69, 0x76, 0x61,
	0x6c, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x4c, 0x6f, 0x62, 0x62, 0x79, 0x42, 0x6f,
...
var file_thetan_bot_v1_bot_rivals_proto_goTypes = []interface{}{
	(*GetLobbyBotsRequest)(nil),  // 0: thetan.rivals.v1.GetLobbyBotsRequest
	(*GetLobbyBotsResponse)(nil), // 1: thetan.rivals.v1.GetLobbyBotsResponse
	(*BotInfo)(nil),              // 2: thetan.rivals.v1.BotInfo
}
var file_thetan_bot_v1_bot_rivals_proto_depIdxs = []int32{
	2, // 0: thetan.rivals.v1.GetLobbyBotsResponse.bots:type_name -> thetan.rivals.v1.BotInfo
	0, // 1: thetan.rivals.v1.BotRivalsService.GetLobbyBots:input_type -> thetan.rivals.v1.GetLobbyBotsRequest
	1, // 2: thetan.rivals.v1.BotRivalsService.GetLobbyBots:output_type -> thetan.rivals.v1.GetLobbyBotsResponse
...
func file_thetan_bot_v1_bot_rivals_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_thetan_bot_v1_bot_rivals_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLobbyBotsRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
		...
		file_thetan_bot_v1_bot_rivals_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*GetLobbyBotsResponse); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
