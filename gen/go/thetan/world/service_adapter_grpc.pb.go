...
const (
	...
	ThetanWorldAdapterService_IsValidItem_FullMethodName       = "/thetan.world.v1.ThetanWorldAdapterService/IsValidItem"
	ThetanWorldAdapterService_SendItem_FullMethodName          = "/thetan.world.v1.ThetanWorldAdapterService/SendItem"
)
...
type ThetanWorldAdapterServiceClient interface {
	...
	IsValidItem(ctx context.Context, in *SimpleItem, opts ...grpc.CallOption) (*CheckItemResponse, error)
	SendItem(ctx context.Context, in *SendItemsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *thetanWorldAdapterServiceClient) IsValidItem(ctx context.Context, in *SimpleItem, opts ...grpc.CallOption) (*CheckItemResponse, error) {
	out := new(CheckItemResponse)
	err := c.cc.Invoke(ctx, ThetanWorldAdapterService_IsValidItem_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *thetanWorldAdapterServiceClient) SendItem(ctx context.Context, in *SendItemsRequest, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, ThetanWorldAdapterService_SendItem_FullMethodName, in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ThetanWorldAdapterServiceServer interface {
	...
	IsValidItem(context.Context, *SimpleItem) (*CheckItemResponse, error)
	SendItem(context.Context, *SendItemsRequest) (*emptypb.Empty, error)
...
func (UnimplementedThetanWorldAdapterServiceServer) IsValidItem(context.Context, *SimpleItem) (*CheckItemResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method IsValidItem not implemented")
}
func (UnimplementedThetanWorldAdapterServiceServer) SendItem(context.Context, *SendItemsRequest) (*emptypb.Empty, error) {
...
func _ThetanWorldAdapterService_IsValidItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SimpleItem)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ThetanWorldAdapterServiceServer).IsValidItem(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ThetanWorldAdapterService_IsValidItem_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThetanWorldAdapterServiceServer).IsValidItem(ctx, req.(*SimpleItem))
	}
	return interceptor(ctx, in, info, handler)
}

func _ThetanWorldAdapterService_SendItem_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(SendItemsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ThetanWorldAdapterServiceServer).SendItem(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ThetanWorldAdapterService_SendItem_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ThetanWorldAdapterServiceServer).SendItem(ctx, req.(*SendItemsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ThetanWorldAdapterService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "IsValidItem",
			Handler:    _ThetanWorldAdapterService_IsValidItem_Handler,
		},
		{
			MethodName: "SendItem",
			Handler:    _ThetanWorldAdapterService_SendItem_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "thetan/world/service_adapter.proto",
}
