...
type PlayerInfoMatchProto struct {
	...
	Country  string   `protobuf:"bytes,18,opt,name=country,proto3" json:"country,omitempty"` //using for get bot
}
...
func (x *PlayerInfoMatchProto) GetCountry() string {
	if x != nil {
		return x.Country
	}
	return ""
...
var file_thetan_immortal_v1_immortal_shared_proto_rawDesc = []byte{
	...
	0x05, 0x52, 0x05, 0x63, 0x6c, 0x61, 0x73, 0x73, 0x22, 0xd4, 0x04, 0x0a, 0x14, 0x50, 0x6c, 0x61,
	...
	0x01, 0x52, 0x02, 0x72, 0x64, 0x12, 0x18, 0x0a, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79,
	0x18, 0x12, 0x20, 0x01, 0x28, 0x09, 0x52, 0x07, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x72, 0x79, 0x2a,
