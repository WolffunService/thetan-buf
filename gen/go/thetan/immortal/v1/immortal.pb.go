...
var file_thetan_immortal_v1_immortal_proto_rawDesc = []byte{
	...
	0x01, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08, 0x73, 0x65, 0x61, 0x73, 0x6f, 0x6e, 0x49, 0x44, 0x32,
	0xe9, 0x05, 0x0a, 0x0f, 0x49, 0x6d, 0x6d, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x53, 0x65, 0x72, 0x76,
	...
	0x6c, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x42, 0xca, 0x01, 0x0a, 0x16,
...
var file_thetan_immortal_v1_immortal_proto_goTypes = []interface{}{
	...
	(GameMode)(0),                    // 24: thetan.immortal.v1.GameMode
	(*Hero)(nil),                     // 25: thetan.immortal.v1.Hero
	(*Skill)(nil),                    // 26: thetan.immortal.v1.Skill
	(Arena)(0),                       // 27: thetan.immortal.v1.Arena
	(*SkillRating)(nil),              // 28: thetan.immortal.v1.SkillRating
	(*HeroFull)(nil),                 // 29: thetan.immortal.v1.HeroFull
	(*SkillFull)(nil),                // 30: thetan.immortal.v1.SkillFull
}
var file_thetan_immortal_v1_immortal_proto_depIdxs = []int32{
	...
	24, // 2: thetan.immortal.v1.BattleEndRequest.gameMode:type_name -> thetan.immortal.v1.GameMode
	25, // 3: thetan.immortal.v1.PlayerMatchInfo.hero:type_name -> thetan.immortal.v1.Hero
	26, // 4: thetan.immortal.v1.PlayerMatchInfo.skills:type_name -> thetan.immortal.v1.Skill
	27, // 5: thetan.immortal.v1.BattleEndResponse.arena:type_name -> thetan.immortal.v1.Arena
	...
	26, // 8: thetan.immortal.v1.BattleEndResponse.skills:type_name -> thetan.immortal.v1.Skill
	28, // 9: thetan.immortal.v1.BattleEndPlayer.skillRating:type_name -> thetan.immortal.v1.SkillRating
	29, // 10: thetan.immortal.v1.GetHeroConfigResponse.heroes:type_name -> thetan.immortal.v1.HeroFull
	21, // 11: thetan.immortal.v1.GetHeroConfigResponse.heroRarities:type_name -> thetan.immortal.v1.GetHeroConfigResponse.HeroRaritiesEntry
	30, // 12: thetan.immortal.v1.GetSkillConfigResponse.skills:type_name -> thetan.immortal.v1.SkillFull
	22, // 13: thetan.immortal.v1.GetSkillConfigResponse.skillRarities:type_name -> thetan.immortal.v1.GetSkillConfigResponse.SkillRaritiesEntry
	...
	2,  // 26: thetan.immortal.v1.ImmortalService.SearchPlayerInfo:output_type -> thetan.immortal.v1.SearchPlayerInfoResponse
	4,  // 27: thetan.immortal.v1.ImmortalService.GetUserProfile:output_type -> thetan.immortal.v1.GetUserProfileResponse
	7,  // 28: thetan.immortal.v1.ImmortalService.BattleEnd:output_type -> thetan.immortal.v1.BattleEndResponse
	11, // 29: thetan.immortal.v1.ImmortalService.GetHeroConfig:output_type -> thetan.immortal.v1.GetHeroConfigResponse
	14, // 30: thetan.immortal.v1.ImmortalService.GetSkillConfig:output_type -> thetan.immortal.v1.GetSkillConfigResponse
	17, // 31: thetan.immortal.v1.ImmortalService.GetListFriends:output_type -> thetan.immortal.v1.GetUserFriendResponse
	20, // 32: thetan.immortal.v1.ImmortalService.GetSeasonal:output_type -> thetan.immortal.v1.GetSeasonalResponse
