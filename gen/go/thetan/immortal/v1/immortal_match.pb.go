...
type ImmortalPlayerInfoMatchProto struct {
	...
	Hero         []byte   `protobuf:"bytes,11,opt,name=hero,proto3" json:"hero,omitempty"`          // 0: heroID; 1: skinID; 2: heroType; 3: level
	Skills       [][]byte `protobuf:"bytes,12,rep,name=skills,proto3" json:"skills,omitempty"`      // 0: skillID; 1: level
...
func (x *ImmortalPlayerInfoMatchProto) GetHero() []byte {
	if x != nil {
		return x.Hero
	}
	return nil
...
func (x *ImmortalPlayerInfoMatchProto) GetSkills() [][]byte {
	if x != nil {
		return x.Skills
	}
	return nil
...
var file_thetan_immortal_v1_immortal_match_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x65, 0x67, 0x69, 0x6f, 0x6e, 0x22, 0xa8, 0x03, 0x0a, 0x1c, 0x49, 0x6d, 0x6d, 0x6f,
	...
	0x12, 0x12, 0x0a, 0x04, 0x68, 0x65, 0x72, 0x6f, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x04,
	0x68, 0x65, 0x72, 0x6f, 0x12, 0x16, 0x0a, 0x06, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x73, 0x18, 0x0c,
	0x20, 0x03, 0x28, 0x0c, 0x52, 0x06, 0x73, 0x6b, 0x69, 0x6c, 0x6c, 0x73, 0x12, 0x1a, 0x0a, 0x08,
	0x62, 0x6f, 0x74, 0x42, 0x72, 0x61, 0x69, 0x6e, 0x18, 0x0d, 0x20, 0x01, 0x28, 0x05, 0x52, 0x08,
	0x62, 0x6f, 0x74, 0x42, 0x72, 0x61, 0x69, 0x6e, 0x12, 0x18, 0x0a, 0x07, 0x72, 0x65, 0x67, 0x69,
	0x6f, 0x6e, 0x73, 0x18, 0x0e, 0x20, 0x03, 0x28, 0x05, 0x52, 0x07, 0x72, 0x65, 0x67, 0x69, 0x6f,
	0x6e, 0x73, 0x22, 0x60, 0x0a, 0x12, 0x49, 0x6d, 0x6d, 0x6f, 0x72, 0x74, 0x61, 0x6c, 0x54, 0x69,
...
var file_thetan_immortal_v1_immortal_match_proto_msgTypes = make([]protoimpl.MessageInfo, 6)
var file_thetan_immortal_v1_immortal_match_proto_goTypes = []interface{}{
	...
	(*ImmortalTicketData)(nil),              // 2: thetan.immortal.v1.ImmortalTicketData
	...
	(*CancelTicketSuccess)(nil),             // 5: thetan.immortal.v1.CancelTicketSuccess
}
var file_thetan_immortal_v1_immortal_match_proto_depIdxs = []int32{
	...
	1, // 1: thetan.immortal.v1.ImmortalTicketData.players:type_name -> thetan.immortal.v1.ImmortalPlayerInfoMatchProto
	3, // 2: thetan.immortal.v1.ImmortalMatchDirectorService.CancelTicket:input_type -> thetan.immortal.v1.ImmortalCancelTicketRequest
	4, // 3: thetan.immortal.v1.ImmortalMatchDirectorService.CancelTicket:output_type -> thetan.immortal.v1.ImmortalCancelTicketResponse
