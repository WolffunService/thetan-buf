...
type CreateMatchOfflineRequest struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
	...
	MatchVersion string                     `protobuf:"bytes,4,opt,name=matchVersion,proto3" json:"matchVersion,omitempty"`
}

func (x *CreateMatchOfflineRequest) Reset() {
	*x = CreateMatchOfflineRequest{}
	if protoimpl.UnsafeEnabled {
...
func (x *CreateMatchOfflineRequest) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*CreateMatchOfflineRequest) ProtoMessage() {}

func (x *CreateMatchOfflineRequest) ProtoReflect() protoreflect.Message {
	mi := &file_thetan_rivals_v1_rivals_match_proto_msgTypes[2]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use CreateMatchOfflineRequest.ProtoReflect.Descriptor instead.
func (*CreateMatchOfflineRequest) Descriptor() ([]byte, []int) {
	return file_thetan_rivals_v1_rivals_match_proto_rawDescGZIP(), []int{2}
}

func (x *CreateMatchOfflineRequest) GetInGameMode() v1.InGameMode {
	if x != nil {
		return x.InGameMode
	}
...
func (x *CreateMatchOfflineRequest) GetPlayers() []*v1.PlayerInfoMatchProto {
	if x != nil {
		return x.Players
	}
	return nil
...
func (x *CreateMatchOfflineRequest) GetRegions() []int32 {
	if x != nil {
		return x.Regions
	}
	return nil
...
func (x *CreateMatchOfflineRequest) GetMatchVersion() string {
	if x != nil {
...
var file_thetan_rivals_v1_rivals_match_proto_rawDesc = []byte{
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0xd9, 0x01, 0x0a, 0x19, 0x43, 0x72,
	0x65, 0x61, 0x74, 0x65, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x66, 0x66, 0x6c, 0x69, 0x6e, 0x65,
	0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x12, 0x3c, 0x0a, 0x0a, 0x69, 0x6e, 0x47, 0x61, 0x6d,
	...
	0x65, 0x4d, 0x6f, 0x64, 0x65, 0x12, 0x40, 0x0a, 0x07, 0x70, 0x6c, 0x61, 0x79, 0x65, 0x72, 0x73,
	...
	,
	...
	0x76, 0x31, 0x2e, 0x52, 0x69, 0x76, 0x61, 0x6c, 0x43, 0x61, 0x6e, 0x63, 0x65, 0x6c, 0x54, 0x69,
	0x63, 0x6b, 0x65, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x00, 0x12, 0x68,
	0x0a, 0x12, 0x43, 0x72, 0x65, 0x61, 0x74, 0x65, 0x4d, 0x61, 0x74, 0x63, 0x68, 0x4f, 0x6e, 0x62,
	0x6f, 0x61, 0x72, 0x64, 0x12, 0x25, 0x2e, 0x74, 0x68, 0x65, 0x74, 0x61, 0x6e, 0x2e, 0x72, 0x69,
	0x76, 0x61, 0x6c, 0x73, 0x2e, 0x76, 0x31, 0x2e, 0x47, 0x65, 0x74, 0x4d, 0x61, 0x74, 0x63, 0x68,
	0x49, 0x6e, 0x66, 0x6f, 0x52, 0x65, 0x71, 0x75, 0x65, 0x73, 0x74, 0x1a, 0x29, 0x2e, 0x74, 0x68,
	...
	,
...
var file_thetan_rivals_v1_rivals_match_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_thetan_rivals_v1_rivals_match_proto_goTypes = []interface{}{
	...
	(*CreateMatchOfflineRequest)(nil),  // 2: thetan.rivals.v1.CreateMatchOfflineRequest
	(v1.InGameMode)(0),                 // 3: thetan.shared.v1.InGameMode
	(*v1.PlayerInfoMatchProto)(nil),    // 4: thetan.shared.v1.PlayerInfoMatchProto
	(*GetMatchInfoRequest)(nil),        // 5: thetan.rivals.v1.GetMatchInfoRequest
	(*v1.MatchFoundResponseProto)(nil), // 6: thetan.shared.v1.MatchFoundResponseProto
}
var file_thetan_rivals_v1_rivals_match_proto_depIdxs = []int32{
	3, // 0: thetan.rivals.v1.CreateMatchOfflineRequest.inGameMode:type_name -> thetan.shared.v1.InGameMode
	4, // 1: thetan.rivals.v1.CreateMatchOfflineRequest.players:type_name -> thetan.shared.v1.PlayerInfoMatchProto
	0, // 2: thetan.rivals.v1.RivalMatchDirectorService.CancelTicket:input_type -> thetan.rivals.v1.RivalCancelTicketRequest
	5, // 3: thetan.rivals.v1.RivalMatchDirectorService.CreateMatchOnboard:input_type -> thetan.rivals.v1.GetMatchInfoRequest
	2, // 4: thetan.rivals.v1.RivalMatchDirectorService.CreateMatchOffline:input_type -> thetan.rivals.v1.CreateMatchOfflineRequest
	1, // 5: thetan.rivals.v1.RivalMatchDirectorService.CancelTicket:output_type -> thetan.rivals.v1.RivalCancelTicketResponse
	6, // 6: thetan.rivals.v1.RivalMatchDirectorService.CreateMatchOnboard:output_type -> thetan.shared.v1.MatchFoundResponseProto
	6, // 7: thetan.rivals.v1.RivalMatchDirectorService.CreateMatchOffline:output_type -> thetan.shared.v1.MatchFoundResponseProto
...
func file_thetan_rivals_v1_rivals_match_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_thetan_rivals_v1_rivals_match_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*CreateMatchOfflineRequest); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
