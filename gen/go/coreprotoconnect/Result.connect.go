...
type GRPCResultClient interface {
	GetMatchResult(context.Context, *connect_go.Request[coreproto.MatchResultRequest]) (*connect_go.Response[coreproto.MatchResultReply], error)
}
...
func NewGRPCResultClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) GRPCResultClient {
	...
	return &gRPCResultClient{
		getMatchResult: connect_go.NewClient[coreproto.MatchResultRequest, coreproto.MatchResultReply](
			httpClient,
...
type gRPCResultClient struct {
	getMatchResult *connect_go.Client[coreproto.MatchResultRequest, coreproto.MatchResultReply]
}

// GetMatchResult calls GRPCResult.GetMatchResult.
func (c *gRPCResultClient) GetMatchResult(ctx context.Context, req *connect_go.Request[coreproto.MatchResultRequest]) (*connect_go.Response[coreproto.MatchResultReply], error) {
...
func (UnimplementedGRPCResultHandler) GetMatchResult(context.Context, *connect_go.Request[coreproto.MatchResultRequest]) (*connect_go.Response[coreproto.MatchResultReply], error) {
