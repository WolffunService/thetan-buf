...
type MatchServiceClient interface {
	CreateMatchWithVersion(context.Context, *connect_go.Request[coreproto.MatchProtoVersionPackage]) (*connect_go.ServerStreamForClient[coreproto.MatchProtoPackage], error)
	// register de nhan su kien match found
	RegisterMatchFound(context.Context, *connect_go.Request[coreproto.MatchProtoPackage]) (*connect_go.ServerStreamForClient[coreproto.MatchProtoPackage], error)
	CancelMatchMaking(context.Context, *connect_go.Request[coreproto.MatchProtoPackage]) (*connect_go.Response[coreproto.MatchProtoPackage], error)
}
...
func NewMatchServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) MatchServiceClient {
	...
	return &matchServiceClient{
		createMatchWithVersion: connect_go.NewClient[coreproto.MatchProtoVersionPackage, coreproto.MatchProtoPackage](
			httpClient,
			baseURL+MatchServiceCreateMatchWithVersionProcedure,
			opts...,
		),
		registerMatchFound: connect_go.NewClient[coreproto.MatchProtoPackage, coreproto.MatchProtoPackage](
			httpClient,
			baseURL+MatchServiceRegisterMatchFoundProcedure,
			opts...,
		),
		cancelMatchMaking: connect_go.NewClient[coreproto.MatchProtoPackage, coreproto.MatchProtoPackage](
			httpClient,
...
type matchServiceClient struct {
	createMatchWithVersion *connect_go.Client[coreproto.MatchProtoVersionPackage, coreproto.MatchProtoPackage]
	registerMatchFound     *connect_go.Client[coreproto.MatchProtoPackage, coreproto.MatchProtoPackage]
	cancelMatchMaking      *connect_go.Client[coreproto.MatchProtoPackage, coreproto.MatchProtoPackage]
}

// CreateMatchWithVersion calls core.proto.MatchService.CreateMatchWithVersion.
func (c *matchServiceClient) CreateMatchWithVersion(ctx context.Context, req *connect_go.Request[coreproto.MatchProtoVersionPackage]) (*connect_go.ServerStreamForClient[coreproto.MatchProtoPackage], error) {
...
func (c *matchServiceClient) RegisterMatchFound(ctx context.Context, req *connect_go.Request[coreproto.MatchProtoPackage]) (*connect_go.ServerStreamForClient[coreproto.MatchProtoPackage], error) {
	return c.registerMatchFound.CallServerStream(ctx, req)
}

// CancelMatchMaking calls core.proto.MatchService.CancelMatchMaking.
func (c *matchServiceClient) CancelMatchMaking(ctx context.Context, req *connect_go.Request[coreproto.MatchProtoPackage]) (*connect_go.Response[coreproto.MatchProtoPackage], error) {
...
type MatchServiceHandler interface {
	CreateMatchWithVersion(context.Context, *connect_go.Request[coreproto.MatchProtoVersionPackage], *connect_go.ServerStream[coreproto.MatchProtoPackage]) error
	// register de nhan su kien match found
	RegisterMatchFound(context.Context, *connect_go.Request[coreproto.MatchProtoPackage], *connect_go.ServerStream[coreproto.MatchProtoPackage]) error
	CancelMatchMaking(context.Context, *connect_go.Request[coreproto.MatchProtoPackage]) (*connect_go.Response[coreproto.MatchProtoPackage], error)
}
...
func (UnimplementedMatchServiceHandler) CreateMatchWithVersion(context.Context, *connect_go.Request[coreproto.MatchProtoVersionPackage], *connect_go.ServerStream[coreproto.MatchProtoPackage]) error {
...
func (UnimplementedMatchServiceHandler) RegisterMatchFound(context.Context, *connect_go.Request[coreproto.MatchProtoPackage], *connect_go.ServerStream[coreproto.MatchProtoPackage]) error {
...
func (UnimplementedMatchServiceHandler) CancelMatchMaking(context.Context, *connect_go.Request[coreproto.MatchProtoPackage]) (*connect_go.Response[coreproto.MatchProtoPackage], error) {
...
type MatchHandleServiceClient interface {
	HandlePlayAgain(context.Context, *connect_go.Request[coreproto.DataPlayAgainSuccess]) (*connect_go.Response[coreproto.EmptyResponse], error)
	HandleDeleteTicket(context.Context, *connect_go.Request[coreproto.DeleteTicketSuccess]) (*connect_go.Response[coreproto.EmptyResponse], error)
}
...
func NewMatchHandleServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) MatchHandleServiceClient {
	...
	return &matchHandleServiceClient{
		handlePlayAgain: connect_go.NewClient[coreproto.DataPlayAgainSuccess, coreproto.EmptyResponse](
			httpClient,
			baseURL+MatchHandleServiceHandlePlayAgainProcedure,
			opts...,
		),
		handleDeleteTicket: connect_go.NewClient[coreproto.DeleteTicketSuccess, coreproto.EmptyResponse](
			httpClient,
...
type matchHandleServiceClient struct {
	handlePlayAgain    *connect_go.Client[coreproto.DataPlayAgainSuccess, coreproto.EmptyResponse]
	handleDeleteTicket *connect_go.Client[coreproto.DeleteTicketSuccess, coreproto.EmptyResponse]
}

// HandlePlayAgain calls core.proto.MatchHandleService.HandlePlayAgain.
func (c *matchHandleServiceClient) HandlePlayAgain(ctx context.Context, req *connect_go.Request[coreproto.DataPlayAgainSuccess]) (*connect_go.Response[coreproto.EmptyResponse], error) {
	return c.handlePlayAgain.CallUnary(ctx, req)
}

// HandleDeleteTicket calls core.proto.MatchHandleService.HandleDeleteTicket.
func (c *matchHandleServiceClient) HandleDeleteTicket(ctx context.Context, req *connect_go.Request[coreproto.DeleteTicketSuccess]) (*connect_go.Response[coreproto.EmptyResponse], error) {
...
func (UnimplementedMatchHandleServiceHandler) HandlePlayAgain(context.Context, *connect_go.Request[coreproto.DataPlayAgainSuccess]) (*connect_go.Response[coreproto.EmptyResponse], error) {
...
func (UnimplementedMatchHandleServiceHandler) HandleDeleteTicket(context.Context, *connect_go.Request[coreproto.DeleteTicketSuccess]) (*connect_go.Response[coreproto.EmptyResponse], error) {
...
type MatchDirectorServiceClient interface {
	CancelTicket(context.Context, *connect_go.Request[coreproto.MatchProtoPackage]) (*connect_go.Response[coreproto.EmptyResponse], error)
	GetBots(context.Context, *connect_go.Request[coreproto.GetBotsRequest]) (*connect_go.Response[coreproto.BotsResponse], error)
	CreateMatchOnboard(context.Context, *connect_go.Request[coreproto.CreateMatchOnboardRequest]) (*connect_go.Response[coreproto.MatchFoundResponseExtProto], error)
}
...
func NewMatchDirectorServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) MatchDirectorServiceClient {
	...
	return &matchDirectorServiceClient{
		cancelTicket: connect_go.NewClient[coreproto.MatchProtoPackage, coreproto.EmptyResponse](
			httpClient,
			baseURL+MatchDirectorServiceCancelTicketProcedure,
			opts...,
		),
		getBots: connect_go.NewClient[coreproto.GetBotsRequest, coreproto.BotsResponse](
			httpClient,
			baseURL+MatchDirectorServiceGetBotsProcedure,
			opts...,
		),
		createMatchOnboard: connect_go.NewClient[coreproto.CreateMatchOnboardRequest, coreproto.MatchFoundResponseExtProto](
			httpClient,
...
type matchDirectorServiceClient struct {
	cancelTicket       *connect_go.Client[coreproto.MatchProtoPackage, coreproto.EmptyResponse]
	getBots            *connect_go.Client[coreproto.GetBotsRequest, coreproto.BotsResponse]
	createMatchOnboard *connect_go.Client[coreproto.CreateMatchOnboardRequest, coreproto.MatchFoundResponseExtProto]
}

// CancelTicket calls core.proto.MatchDirectorService.CancelTicket.
func (c *matchDirectorServiceClient) CancelTicket(ctx context.Context, req *connect_go.Request[coreproto.MatchProtoPackage]) (*connect_go.Response[coreproto.EmptyResponse], error) {
	return c.cancelTicket.CallUnary(ctx, req)
}

// GetBots calls core.proto.MatchDirectorService.GetBots.
func (c *matchDirectorServiceClient) GetBots(ctx context.Context, req *connect_go.Request[coreproto.GetBotsRequest]) (*connect_go.Response[coreproto.BotsResponse], error) {
	return c.getBots.CallUnary(ctx, req)
}

// CreateMatchOnboard calls core.proto.MatchDirectorService.CreateMatchOnboard.
func (c *matchDirectorServiceClient) CreateMatchOnboard(ctx context.Context, req *connect_go.Request[coreproto.CreateMatchOnboardRequest]) (*connect_go.Response[coreproto.MatchFoundResponseExtProto], error) {
...
func (UnimplementedMatchDirectorServiceHandler) CancelTicket(context.Context, *connect_go.Request[coreproto.MatchProtoPackage]) (*connect_go.Response[coreproto.EmptyResponse], error) {
...
func (UnimplementedMatchDirectorServiceHandler) GetBots(context.Context, *connect_go.Request[coreproto.GetBotsRequest]) (*connect_go.Response[coreproto.BotsResponse], error) {
...
func (UnimplementedMatchDirectorServiceHandler) CreateMatchOnboard(context.Context, *connect_go.Request[coreproto.CreateMatchOnboardRequest]) (*connect_go.Response[coreproto.MatchFoundResponseExtProto], error) {
