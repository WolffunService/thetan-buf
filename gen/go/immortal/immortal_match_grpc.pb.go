...
const (
	ImmortalMatchDirectorService_CancelTicket_FullMethodName = "/immortal.ImmortalMatchDirectorService/CancelTicket"
)
...
var ImmortalMatchDirectorService_ServiceDesc = grpc.ServiceDesc{
	ServiceName: "immortal.ImmortalMatchDirectorService",
