...
package srvfirebaseconnect

import (
	srvfirebase "./srvfirebase"
	context "context"
	errors "errors"
...
type FirebaseServiceClient interface {
	TrackPlayerStat(context.Context, *connect_go.Request[srvfirebase.TrackPlayerStatRequest]) (*connect_go.Response[emptypb.Empty], error)
}
...
func NewFirebaseServiceClient(httpClient connect_go.HTTPClient, baseURL string, opts ...connect_go.ClientOption) FirebaseServiceClient {
	...
	return &firebaseServiceClient{
		trackPlayerStat: connect_go.NewClient[srvfirebase.TrackPlayerStatRequest, emptypb.Empty](
			httpClient,
...
type firebaseServiceClient struct {
	trackPlayerStat *connect_go.Client[srvfirebase.TrackPlayerStatRequest, emptypb.Empty]
}

// TrackPlayerStat calls services.FirebaseService.TrackPlayerStat.
func (c *firebaseServiceClient) TrackPlayerStat(ctx context.Context, req *connect_go.Request[srvfirebase.TrackPlayerStatRequest]) (*connect_go.Response[emptypb.Empty], error) {
...
func (UnimplementedFirebaseServiceHandler) TrackPlayerStat(context.Context, *connect_go.Request[srvfirebase.TrackPlayerStatRequest]) (*connect_go.Response[emptypb.Empty], error) {
